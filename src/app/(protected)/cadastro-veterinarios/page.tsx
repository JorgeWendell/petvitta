...
export default function CadastroVeterinariosPage() {
  ...
  return (
    <ClinicGuard>
      <div className="container mx-auto py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold">Cadastro de Veterinários</h1>
          <p className="text-muted-foreground mt-2">
            Gerencie os veterinários da sua clínica
          </p>
        </div>
        <DoctorsList clinicId={data.clinic.id} />
      </div>
    </ClinicGuard>
  );
}
